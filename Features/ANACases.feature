...
#		Given user wait for 10 seconds
#			
#		Given I click on the "DiagnosisSearch_btn" button
#		Then user enters ICDCode as "J44.9"
#		Given I click on the "DiagnosisLayoutSearch_btn" button	
#		Given user click on Daignosis ModalSubmit "DiagnosisLayoutChkbx_btn" button with javascript		
#		Given I click on the "DiagnosisLayoutChkbx_btn" button
#		Given user wait for 10 seconds
#		Given I click on the "ModalSubmit_btn" button	
#		Given user click on Daignosis ModalSubmit "ModalSubmit_btn" button with javascript
#		Given user wait for 10 seconds
#		
...
#		When user enters PhysicianName as "DAVID"
 ...
 #	  Given I click on the "Submit_btn" button
 #	  Given user wait for 5 seconds
 #	  When user enters HCPC as "A0375"
